    ...
    <section class="entry-content" itemprop="articleBody">
        ...
        <div class="content-container myaccount">
            <ul class="tabs" data-tabs id="example-tabs">
                ...
                <li class="tabs-title"><a data-tabs-target="pane2" href="#pane2">members directory</a></li>
                <li class="tabs-title"><a data-tabs-target="pane3" href="#pane3">annual meetings</a></li>
                <li class="tabs-title"><a data-tabs-target="pane4" href="#pane4">annual meetings</a></li>
